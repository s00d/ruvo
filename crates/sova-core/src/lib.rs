...
pub use devtools_config::DevToolsConfigRegistry;
pub use dispatch::AppDispatch;
pub use error::{Error, IntoResponse, Result};
pub use events::{Event, EventBus};
#[cfg(any(test, feature = "testing"))]
pub use middleware::logger_clear_skip_paths;
pub use middleware::{
    after, around, before, logger, logger_should_skip, logger_skip_path, logger_skip_paths,
    map_html, with_state, Next,
};
pub use plugin::{
...
pub mod extend {
    ...
    pub use crate::handler::{BoxFuture, ErrorResponse, FallibleHandler, Handler, IntoHandler};
    pub use crate::html::{
    ...
    pub use crate::router::{join_paths, normalize_path, to_brace_path, RouteEntry, RouteTable};
