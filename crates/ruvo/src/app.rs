...
/// Application builder — thin wrapper over [`ruvo_core::App`].
pub struct App(ruvo_core::App);

impl App {
    pub fn new() -> Self {
        Self(ruvo_core::App::new())
    }
...
impl From<ruvo_core::App> for App {
    fn from(app: ruvo_core::App) -> Self {
        Self(app)
    }
}

impl From<App> for ruvo_core::App {
...
pub struct BoundApp(ruvo_core::BoundApp);
...
impl BoundApp {
    ...
    #[cfg(feature = "tls")]
    pub fn tls(self, config: ruvo_core::Tls) -> Result<Self> {
