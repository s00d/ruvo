...
Patterns copied from in-tree plugins (cookies→csrf, pools, tasks, store).

> Author guide — edit `docs/.vitepress/plugin-sdk-guides/recipes.md`, then `pnpm docs:generate`.
