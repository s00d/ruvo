...
| [`sova-auth`](./sova-auth/) | `0.1.4` | Fortify-style authentication for Sova (register, 2FA, reset, roles) | [guide](https://s00d.github.io/sova/plugins/auth) |
...
| [`sova-notifications`](./sova-notifications/) | `0.1.2` | Database notifications with channels, ACL, optional WS/mail | [guide](https://s00d.github.io/sova/plugins/notifications) |
