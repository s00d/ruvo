...
impl MailExt for Request {
    fn mail(&self) -> Email {
        ...
        {
            if let Some(templates) = self.try_state::<sova_templates::MiniJinjaTemplates>() {
...
impl Plugin for Mail {
    ...
    fn install(self, app: &mut App) {
        ...
        #[cfg(feature = "templates")]
        {
            if let Some(t) = app.try_state::<sova_templates::MiniJinjaTemplates>() {
            ...
            app.on_startup(move |state| {
                ...
                async move {
                    if wire.templates().is_none() {
                        if let Some(t) = state.get::<sova_templates::MiniJinjaTemplates>() {
