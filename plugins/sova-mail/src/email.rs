...
pub struct Email {
    ...
    #[cfg(feature = "templates")]
    ambient: Option<sova_templates::FrozenAmbient>,
...
impl Email {
    ...
    #[cfg(feature = "templates")]
    pub(crate) fn with_ambient(mut self, ambient: sova_templates::FrozenAmbient) -> Self {
    ...
    /// Requires feature `templates` and an installed [`sova_templates::MiniJinjaTemplates`]
