...
use ruvo_auth::{assign_role, AuthMigrator, Feature, Fortify};
use ruvo_core::{ClientRequest, ResponseAssert, TestClient};
use ruvo_mail::{FakeMail, Mail};
...
async fn login(c: &TestClient, email: &str, password: &str) -> ruvo_core::Response {
