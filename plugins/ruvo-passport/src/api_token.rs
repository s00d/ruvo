...
use ruvo_db::{DbError, DbHandle};
use sea_orm::{ActiveModelTrait, ColumnTrait, EntityTrait, QueryFilter, Set};
use serde::{Deserialize, Serialize};

pub const PAT_PREFIX: &str = "rvpat_";
...
/// Build plaintext `rvpat_<prefix>_<secret>` and return `(full, prefix)`.
...
/// Parse `rvpat_<prefix>_<secret>` → prefix.
